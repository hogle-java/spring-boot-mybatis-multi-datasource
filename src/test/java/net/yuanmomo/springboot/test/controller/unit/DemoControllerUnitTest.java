...
public class DemoControllerUnitTest extends BaseUnitTest {
    ...
    public void testSelectDemoList() throws Exception {
        ...
        // check response
        this.assertJson(AjaxResponseBean.Const.PARAMETER_INVALID_ERROR_RESPONSE_BEAN, this.perform(requestBuilder));
    ...
    public void testUpdateSaveDemo() throws Exception {
        ...
        this.assertJson(AjaxResponseBean.Const.PARAMETER_INVALID_ERROR_RESPONSE_BEAN, perform(requestBuilder));
        ...
        // check return value
        this.assertJson(AjaxResponseBean.Const.SUCCESS_RESPONSE_BEAN, this.perform(requestBuilder));
        /********************************************* 3. select and check ************************************************************/
        // check return value
    ...
    public void testBatchUpdateSaveDemo() throws Exception {
        ...
        // check response
        this.assertJson(AjaxResponseBean.Const.ERROR_RESPONSE_BEAN, this.perform(requestBuilder));
