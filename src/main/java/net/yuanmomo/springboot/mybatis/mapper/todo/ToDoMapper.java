...
public interface ToDoMapper {
     ...
     * @mbg.generated
     */
    @Delete({ "delete from todo.table_to_do", "where id = #{id,jdbcType=BIGINT}" })
     ...
     * @mbg.generated
     */
    @Insert({ "insert into todo.table_to_do (to_do, remark, ", "test_column)", "values (#{toDo,jdbcType=INTEGER}, #{remark,jdbcType=BIGINT}, ", "#{testColumn,jdbcType=VARCHAR})" })
     ...
     * @mbg.generated
     */
    @Select({ "select", "id, to_do, remark, test_column", "from todo.table_to_do", "where id = #{id,jdbcType=BIGINT}" })
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.BIGINT, id = true), @Result(column = "to_do", property = "toDo", jdbcType = JdbcType.INTEGER), @Result(column = "remark", property = "remark", jdbcType = JdbcType.BIGINT), @Result(column = "test_column", property = "testColumn", jdbcType = JdbcType.VARCHAR) })
     ...
     * @mbg.generated
     */
    @Update({ "update todo.table_to_do", "set to_do = #{toDo,jdbcType=INTEGER},", "remark = #{remark,jdbcType=BIGINT},", "test_column = #{testColumn,jdbcType=VARCHAR}", "where id = #{id,jdbcType=BIGINT}" })
    ...
    @Insert({ "<script>", "insert into todo.table_to_do (to_do, ", "remark, test_column)", "values<foreach collection=\"list\" item=\"detail\" index=\"index\" separator=\",\">(#{detail.toDo,jdbcType=INTEGER}, ", "#{detail.remark,jdbcType=BIGINT}, #{detail.testColumn,jdbcType=VARCHAR})</foreach></script>" })
