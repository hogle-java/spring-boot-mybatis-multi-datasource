...
public interface DemoMapper {
     ...
     * @mbg.generated
     */
    @Delete({ "delete from demo.table_demo", "where id = #{id,jdbcType=BIGINT}" })
     ...
     * @mbg.generated
     */
    @Insert({ "insert into demo.table_demo (number, version)", "values (#{number,jdbcType=INTEGER}, #{version,jdbcType=BIGINT})" })
    ...
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.BIGINT, id = true), @Result(column = "number", property = "number", jdbcType = JdbcType.INTEGER), @Result(column = "version", property = "version", jdbcType = JdbcType.BIGINT) })
     ...
     * @mbg.generated
     */
    @Select({ "select", "id, number, version", "from demo.table_demo", "where id = #{id,jdbcType=BIGINT}" })
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.BIGINT, id = true), @Result(column = "number", property = "number", jdbcType = JdbcType.INTEGER), @Result(column = "version", property = "version", jdbcType = JdbcType.BIGINT) })
     ...
     * @mbg.generated
     */
    @Update({ "update demo.table_demo", "set number = #{number,jdbcType=INTEGER},", "version = #{version,jdbcType=BIGINT}", "where id = #{id,jdbcType=BIGINT}" })
     ...
     * @mbg.generated
     */
    @SelectProvider(type = DemoSqlProvider.class, method = "getOneByExample")
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.BIGINT, id = true), @Result(column = "number", property = "number", jdbcType = JdbcType.INTEGER), @Result(column = "version", property = "version", jdbcType = JdbcType.BIGINT) })
    ...
    @Insert({ "<script>", "insert into demo.table_demo (number, ", "version)", "values<foreach collection=\"list\" item=\"detail\" index=\"index\" separator=\",\">(#{detail.number,jdbcType=INTEGER}, ", "#{detail.version,jdbcType=BIGINT})</foreach></script>" })
